    ...
    <ul>
      <li class="flip-container" ontouchstart="this.classList.toggle('hover');">
        <a href="javascript:void(0)" class="flipper">
          <div class="front"><img src="../assets/images/cloud.png" /></div>
          <div class="back"><img src="../assets/images/card.png" /></div>
        </a>
      </li>
      <!-- <li class="flip-container" ontouchstart="this.classList.toggle('hover');">
        <a href="javascript:void(0)" class="flipper">
          <div class="front"><img src="../assets/images/cloud.png" />前面</div>
          <div class="back"><img src="../assets/images/card.png" />后面</div>
        </a>
      </li> -->
    </ul>
  </div>
